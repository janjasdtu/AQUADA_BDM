function BDM_case1_vis_open(bdDB, virt, savePlot, dmgCat, dmgCatInst)
...
% This function behaves the same way as 'BDM_case1_stat_dpark' but call the
% visualization module instead of the statistics one
...
for wtNo = 1:height(tabWtLayout)
  ...
  if wtDmg(wtNo)
    ...
    set(hRec, 'ButtonDownFcn', {@BDM_case1_vis_wtclick, hAx, tabWtLayout.WTGID(wtNo), tabDmg{wtNo}, bdDB.bladeLength, virt});
